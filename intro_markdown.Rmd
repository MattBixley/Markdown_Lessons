...
inline citations using a .bib file we can cite PalmerPenguins from Alison Horst [@horst2020] and at the same time lets cive the citation for R created by Robert Gentleman [@gentleman2004]
